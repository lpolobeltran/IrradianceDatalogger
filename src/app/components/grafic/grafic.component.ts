  ...
  ngAfterViewInit() {
    ...
    if (ctx) {
      new Chart(ctx, {
        ...
        data: {
          labels: ["13:38:10.86", "13:38:05.85", "13:38:00.85", "13:37:55.84", "13:37:50.84",
        ...
        "13:30:15.42"],  // Etiquetas del eje X
          datasets: [
            {
              label: 'Irradiance Prototipo',
              data: [627.273, 608.182, 621.818, 621.818, 628.636, 589.091, 590.455, 625.909,
                ...
                868.636, 886.364, 924.545, 935.455, 905.455, 947.727, 927.273, 946.364],  // Datos de la primera serie
            ...
            },
            {
              ...
              data: [667.342, 646.595, 637.02, 633.828, 637.02, 640.211, 643.403, 637.02,
                ...
                802.994, 826.933, 841.296, 841.296, 842.892, 855.659, 868.427, 876.406],  // Datos de la segunda serie
