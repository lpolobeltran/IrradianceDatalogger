        ...
        options: {
          ...
          scales: {
            x: {
              ...
              ticks: {
                font: {
                  size: 11 // 🔹 Tamaño de la letra en el eje X (ajusta según necesidad)
                }
              }
            },
            y: {
